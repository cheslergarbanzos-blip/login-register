    ...
    <body>
        ...
        <div id="profile-content">
            ...
            <div class="profile-field">
                ...
                <p id="profile-birthday"><?php echo htmlspecialchars($user['birthday']); ?></p>
            </div>
            
            <a href="LOGOUT.php"><button id="logout-btn">Log Out</button></a>
        ...
        <div id="edit-form" style="display: none;">
            ...
            <form action="VIEW_PROFILE.php" method="post">
                ...
                <button type="button" onclick="toggleEditMode()" style="background-color: #6c757d; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; margin-left: 10px;">Cancel</button>
            </form>
        </div>
